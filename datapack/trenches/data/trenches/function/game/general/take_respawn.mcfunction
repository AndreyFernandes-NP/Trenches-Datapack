...
# função tocar, ele vai de 15 a 14 MUITO rápido, basicamente salvando 1 segundo de tempo antes de dar respawn (que de maneira competitiva, isso atrapalharia muito).
