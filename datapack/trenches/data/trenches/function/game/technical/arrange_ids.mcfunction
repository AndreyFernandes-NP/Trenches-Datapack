...
execute if score #functionType value matches 0 run return run function trenches:game/technical/pts_storage with storage macro input_id[-1]
execute if score #functionType value matches 1 run return run function trenches:game/technical/get_pts with storage macro input_id[-1]
execute if score #functionType value matches 2 run return run function trenches:game/technical/do_respawn with storage macro input_id[-1]