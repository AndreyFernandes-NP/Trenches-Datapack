...
execute unless data storage ui container[{Slot:13b}] run scoreboard players set .button ui 1
...
execute unless score @s ui.page matches 2 run scoreboard players set .page_change ui 1
execute unless score @s ui.page matches 2 run function trenches:ui/refresh