...
execute if score .page_change ui matches 0 run function trenches:ui/page/maisum_teste/buttons

## Aplicar máscara -> se ainda tá na mesma página
execute if score @s ui.page matches 2 run function trenches:ui/page/maisum_teste/mask