...
execute if score .button ui matches 1 as @p run function trenches:classes/can_afford {"target_class":"soldier","currency":"pts"}
execute if score .button ui matches 2 as @p run function trenches:classes/can_afford {"target_class":"scout","currency":"pts"}
