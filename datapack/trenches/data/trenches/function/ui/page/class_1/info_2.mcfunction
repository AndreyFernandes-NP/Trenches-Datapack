tellraw @s ["\n","\n","\n","\n","\n"]
tellraw @s ["",{"text":"[Trenches]","color":"green"},{"text":": ","color":"gray"},{"translate":"trenches.classes.description.scout","with":[{"translate":"trenches.classes.name.soldier","italic":true}],"color":"gray"}]
