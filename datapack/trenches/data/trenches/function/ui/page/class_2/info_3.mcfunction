tellraw @s ["\n","\n","\n","\n","\n"]
tellraw @s ["",{"text":"[Trenches]","color":"green"},{"text":": ","color":"gray"},{"translate":"trenches.classes.description.shooter","with":[{"translate":"trenches.classes.name.warrior","italic":true}],"color":"gray"}]
