...
execute if score .page_change ui matches 0 run function trenches:ui/page/outro_teste/buttons

## Aplicar máscara -> se ainda tá na mesma página
execute if score @s ui.page matches 1 run function trenches:ui/page/outro_teste/mask