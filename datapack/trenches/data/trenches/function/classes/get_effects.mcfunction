...
# Isso serve pra garantir que iremos mexer apenas nesse único storage, poupando todo o resto, não é necessário, mas eu implementei pra evitar qualquer tipo de bug
